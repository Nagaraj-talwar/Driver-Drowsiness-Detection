...
arduino = serial.Serial('/dev/tty.usbmodem11101', 9600)  # Replace 'COM3' with the correct port for your Arduino
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if status1 == 0 and status2 == 0:
            ...
            # if eyes are closed for 10 consecutive frames, start the alarm and send alert to Arduino
            if count >= 10:
